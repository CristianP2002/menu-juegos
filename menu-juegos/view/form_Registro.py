    ...
    def __init__(self,ventana):
        ...
        def registrar_datos():
            if validarDatos():
                ...
                print(f"su nombre es: {usuario.getNombreUsuario()}")
                print(f"su direccion es: {usuario.getDireccion()}")
        ...
        nombre_label = tk.Label(frame2, text="Nombre:", bg="#773dbd", foreground="#ff9e18", font=("Helvetica", 11, "bold"))
        ...
        direccion_label = tk.Label(frame2, text="Dirección:", bg="#773dbd", foreground="#ff9e18", font=("Helvetica", 11, "bold"))
        ...
        telefono_label = tk.Label(frame2, text="Teléfono:", bg="#773dbd", foreground="#ff9e18", font=("Helvetica", 11, "bold"))
        ...
        descripcion_label = tk.Label(frame2, text="Descripción (opcional):", bg="#773dbd", foreground="#ff9e18", font=("Helvetica", 11, "bold"))
        descripcion_label.place(x=65, y=190)
        descripcion_text = scrolledtext.ScrolledText(frame2, width=20, height=4, bg="#773dbd", foreground="#fff", font=("Helvetica", 11, "bold"))
        descripcion_text.place(x=60, y=220)
        
        # Botón para registrar los datos
        registrar_button = tk.Button(frame2, text="REGISTRAR", font=("Helvetica", 9, "bold"), bg="#773dbd", foreground="#fff", width=13, height=1, command=registrar_datos)
        ...
        limpiar_button = tk.Button(frame2, text="LIMPIAR", font=("Arial", 9, "bold"), bg="#FC8A4A", width=13, height=1, command=limpiar_datos)
